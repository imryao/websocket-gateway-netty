...
public class GatewayApplication {
    ...
    public static void main(String[] args) {
        ...
        NettyServer wsServer = new NettyServer("ws-server", 8080, new WebSocketServerInitializer());
        NettyServer httpServer = new NettyServer("http-server", 8081, new HttpServerInitializer());
